    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 150 characters or fewer. Letters, digits, and spaces only.', max_length=150, null=True)),
            ...
            options={
                'permissions': (('is_student', 'Can view student app'), ('is_admin', 'Can view admin app')),
                'constraints': [models.UniqueConstraint(fields=('username',), name='unique-username-field')],
            },
        ),
    ]
