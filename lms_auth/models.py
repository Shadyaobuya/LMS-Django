...
class ModificationTrackingModel(models.Model):
    created_by = models.CharField(
        null=True, blank=True, help_text="User who created record", max_length=30, db_comment="User who created record"
    )
    modified_by = models.CharField(
        null=True, blank=True, help_text="User who modified record", max_length=30, db_comment="User who modified record"
    )
